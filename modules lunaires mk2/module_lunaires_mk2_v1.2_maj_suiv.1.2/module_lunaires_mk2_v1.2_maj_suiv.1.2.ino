...
void loop()
{
  ...
  switch(sensorState)
  {
    case S1_IN_S2_IN: Serial.println("Sensor 1 and 2 are inside of black line"); motor1.run(-95); motor2.run(95); break;
    case S1_IN_S2_OUT: Serial.println("Sensor 2 is outside of black line"); motor1.run(50); motor2.run(-150); break; 
    case S1_OUT_S2_IN: Serial.println("Sensor 1 is outside of black line"); motor1.run(150); motor2.run(-50); break;
